---
name: base-ui
description: "Base UI — A collection of unstyled, accessible React components and utilities for building user interfaces. Import from '@base-ui/react'. Use this skill to implement base-ui components based on their documentation and proper usage."
---
