...
name: motion
description: >
  Platform-specific guidance for Motion (vanilla JS, React) including documentation search, import patterns, performance best practices, willChange usage, MotionValues, and component integration. Triggers: motion, animate, animation, framer-motion, framer motion
